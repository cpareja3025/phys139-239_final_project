...
model_dir = proj_dir.joinpath('models/cvn1').resolve()

train_path = h5_dir.joinpath('train_norm.h5')
test_path = h5_dir.joinpath('test_norm.h5')
log_path = csv_dir.joinpath('cvn1_norm.csv')
best_path = model_dir.joinpath('cvn1_trainnorm_best.pt')
latest_path = model_dir.joinpath('cvn1_trainnorm_latest.pt')
