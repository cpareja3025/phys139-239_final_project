...
class x_model(nn.Module):
    def __init__(self):
        ...
        self.fake_inception = Skip_Connection_Block( in_channels = 256 )
        
        # Shape here .... 
        self.inception3a = Inception_Block(
            in_channels=256,output_1x1=64, output_1x1_block2=96, output_3x3=128, 
            output_5x5_reduce=16, output_5x5= 32, output_pool=32
        )
        ...
        self.inception4a = Inception_Block(
            in_channels=256,output_1x1=64, output_1x1_block2=96, 
            output_3x3=128, output_5x5_reduce=16, output_5x5= 32, output_pool=32
        )
...
class combineXY(nn.Module):
    def __init__(self):
        ...
        self.final_fake_inception = Skip_Connection_Block( in_channels = 512 ) 
